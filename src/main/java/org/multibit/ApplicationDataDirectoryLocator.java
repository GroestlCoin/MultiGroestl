...
public class ApplicationDataDirectoryLocator {
     ...
     * 
     * 1. See if there is a multigroestl.properties in MultiGroestl's current working
     ...
     * 
     * PC System.getenv("APPDATA")/MultiGroestlInExecutableJar
     * 
     * e.g. C:/Documents and Settings/Administrator/Application Data/MultiGroestlInExecutableJar
     * 
     * Mac System.getProperty("user.home")/Library/Application Support/MultiGroestlInExecutableJar
     * 
     * e.g. /Users/jim/Library/Application Support/MultiGroestlInExecutableJar
     * 
     * Linux System.getProperty("user.home")/MultiGroestlInExecutableJar
     * 
     * e.g. /Users/jim/MultiGroestlInExecutableJar
     */
    public String getApplicationDataDirectory() {
        ...
        if (multibitPropertiesFile.exists()) {
            ...
            if (operatingSystemName != null && operatingSystemName.startsWith("Windows")) {
                // Windows os
                applicationDataDirectory = System.getenv("APPDATA") + File.separator + "MultiGroestl";
            } else {
                if (operatingSystemName != null && operatingSystemName.startsWith("Mac")) {
                    ...
                    if ( (new File("../../../../" + FileHandler.USER_PROPERTIES_FILE_NAME)).exists()) {
                        ...
                        applicationDataDirectory = System.getProperty("user.home") + "/Library/Application Support/MultiGroestl";
                    }
                } else {
                    // treat as Linux/ unix variant
                    applicationDataDirectory = System.getProperty("user.home") + "/MultiGroestl";
                }
            }
     ...
     * This is the directory into which MultiGroestl was installed.
     * @throws IOException 
     * 
